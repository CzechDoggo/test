...
const DATABASE_URL = "https://raw.githubusercontent.com/CzechDoggo/test/main/database.json";
const LOG_CHANNEL_ID = "1092123578469732452";
const GUILD_ID = "1000741959855517726";
...
function createLogMessage(player, location) {
    ...
    [Map Link](${DYNMAP_URI})`);
        ...
        embed.setAuthor({
            name: "test 1",
            iconURL: "https://cdn.discordapp.com/attachments/1010294760386330805/1092145405799694396/4473-middle-finger-cat.png"
        })
            .setFooter({
        ...
        const msg = {
            content: `<@&1092181272018817084> PLAYER TRESSPASSING [${location.teams.map(teamname => teamname + "'s").join(" and ")} ${location.name}] : ${player.account}`,
            embeds: [embed],
            components: [row]
        };
        if (log) {
